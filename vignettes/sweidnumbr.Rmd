...
It is also possible to calculate in other timespans than years.
...
If the specific birthdates is needed these can be calculated with ```pin_to_date()```.

```{r example7, message=FALSE, eval=TRUE}
